...
#include "options.h"
//leonardo and separate ESP01, both sources with lots of #ifdef
...
#if UsingUDN2540
UDN2540<4,5,6,7, 15> minutemotor;
UDN2540<8,9,10,16, 14> hourmotor;
#elif UsingDRV8833
DRV8833<4,5,6,7, 15> minutemotor;
DRV8833<8,9,10,16, 14> hourmotor;
#elif UsingULN2003
ULN2003<4,5,6,7> minutemotor;
ULN2003<8,9,10,16> hourmotor;
#else
